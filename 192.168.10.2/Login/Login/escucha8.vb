...
Public Class escucha8
    Dim conexion As OdbcConnection = New OdbcConnection("DSN=OdbcConexion")
    Private Sub Form9_click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Click
        Form2.Show()
    End Sub
    Private Sub Form9_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        TextBox3.Text = Form1.Txt_Usuario.Text
        AxWinsock1.LocalPort = 1515
        AxWinsock1.Listen()
    ...
    Private Sub TextBox1_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles tbConversacion.TextChanged
        ...
        Try
            ...
            stPathArchivo = "C:\HISTORIAL DE MESSENGER\Archivo-Mauricio y " & ListBox1.Text & "-" & Format(Today.Date, "ddMMyyyy") & ".txt" 'Hace referencia al lugar o ubicacion de donde sera almacenada la conversacion.
