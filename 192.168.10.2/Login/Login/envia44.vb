...
Public Class envia44
    ...
    Private Sub envia44_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub FormasDeCaraToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles FormasDeCaraToolStripMenuItem.Click
    ...
    Private Sub tbConversacion_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles tbConversacion.TextChanged
        ...
        Try
            ...
            stPathArchivo = "C:\HISTORIAL DE MESSENGER\Archivo-Mauricio y David" & "-" & Format(Today.Date, "ddMMyyyy") & ".txt" 'Hace referencia al lugar o ubicacion de donde sera almacenada la conversacion.
