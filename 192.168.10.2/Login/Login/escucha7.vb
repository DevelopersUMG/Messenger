...
Public Class escucha7
    Dim conexion As OdbcConnection = New OdbcConnection("DSN=OdbcConexion")
    Private Sub Form8_click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Click
        Form2.Show()
    End Sub
    Private Sub Form8_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        TextBox3.Text = Form1.Txt_Usuario.Text
        AxWinsock1.LocalPort = 3232
        AxWinsock1.Listen()
    ...
    Private Sub tbConversacion_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles tbConversacion.TextChanged
        ...
        Try
            ...
            stPathArchivo = "C:\HISTORIAL DE MESSENGER\Archivo-Mauricio y Mario" & ListBox1.Text & "-" & Format(Today.Date, "ddMMyyyy") & ".txt" 'Hace referencia al lugar o ubicacion de donde sera almacenada la conversacion.
